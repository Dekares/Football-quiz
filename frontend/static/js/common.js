...
const LANGS = {
    tr: {
        ...
        seo_intro: 'Her gün yeni "Günün Futbolcusu" bulmacası, kariyer ve transfer geçmişine dayalı solo futbolcu tahmin oyunu ve arkadaşlarınla 2-8 kişilik canlı düello. Ücretsiz, üyeliksiz.',
        ...
        duel_rule_1: 'İki oyuncu sırayla birer takım seçer.',
    ...
    en: {
        ...
        seo_intro: 'A new "Player of the Day" puzzle every day, a solo footballer guessing game based on career and transfer history, plus live 2-8 player duels with friends. Free, no sign-up.',
        ...
        duel_rule_1: 'Two players each pick a team in turn.',
